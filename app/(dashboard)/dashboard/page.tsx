            ...
            <div className="space-y-3">
              {data.proyectos.length === 0 ? (
                ...
                data.proyectos.map((proy) => (
                  <div key={proy.id} 
                    onClick={() => router.push(`/cotizador?folio=${proy.folio}`)}
                    className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-3xl hover:bg-slate-50 transition-all border border-transparent hover:border-slate-100 group/item gap-6 cursor-pointer"
                  >
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-6 w-full md:w-auto border-t md:border-none pt-4 md:pt-0">
                      ...
                      <select 
                        ...
                        onChange={(e) => {
                          e.stopPropagation();
                          updateEstado(proy.id, e.target.value);
                        }}
